...
export function FinalizarSuporte() {
    ...
    const [message, setMessage] = useState('A BITMAX agradece seu contato, tenha um bom dia!')
        ...
        <div className="h-screen w-full flex flex-col">
            <div className="border-b border-gray-50 bg-green-600">
                <div className="flex h-16 items-center px-2 ">
                    ...
                    <span className="font-bold text-white  uppercase ml-5">Finalizar Suporte</span>
                </div>
            </div>
            <div className="flex-1 mt-3 flex flex-col w-full">
                <p className="mx-5 text-sm text-gray-400">Informe que será enviada ao finalizar o suporte</p>
                <textarea
                    onChange={ev => setMessage(ev.target.value)}
                    value={message}
                     className="flex text-sm bg-gray-50 mx-5 p-2 mt-2 rounded border resize-none focus:outline-none" name="" id="">
